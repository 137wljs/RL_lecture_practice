...
class PPO:
    ...
    def update(self, transition_dist):
        ...
        #     print("Means with NaN values:")
        #     print(means[torch.isnan(means)])  # 输出 NaN 的位置和具体值

        # if torch.isnan(stds).any():
        #     print("NaN detected in stds!")
        #     print("Stds with NaN values:")
        #     print(stds[torch.isnan(stds)])  # 输出 NaN 的位置和具体值
